                ...
                // HEARTBEAT
                    ...
                    while (true) { // Infinite while loop which ask content server every 12 second if it is alive or not
                        ...
                        if (heartbeat.equals("Yes")) {  // If content server is alive
                            // System.out.println(this.uniqueCSid + " IS ALIVEE!!"); // If you want to know everytime heartbeat is successful uncomment this code, I have commented it because it makes the terminal quite messy
                        }
